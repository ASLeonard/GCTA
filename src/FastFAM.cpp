...
void FastFAM::conditionCovarBinReg(Eigen::Ref<VectorXd> y){
    ...
    const double b2 = 1.0;
    const int incr = 1;
    cblas_dgemv(CblasColMajor, CblasNoTrans, num_covar, numi_indi, a1, H.data(), num_covar, y.data(), incr, b1, Hy, incr);
    cblas_dgemv(CblasColMajor, CblasNoTrans, numi_indi, num_covar, a2, covar.data(), numi_indi, Hy, incr, b2, y.data(), incr);
    delete[] Hy;
}
